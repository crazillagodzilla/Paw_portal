...
<div class="bgimg">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto ">
      <li class="nav-item active">
        <a class="nav-link text-dark" href="register.jsp">Register<span class="sr-only">(current)</span></a>
      </li>
      
      <li class="nav-item">
      
        <a class="nav-link text-dark" href="Uploads.jsp?gid=<%=session.getAttribute("gid") %>">My Uploads</a>
  ...
  <h2>JOIN THE CAUSE BY Registering A STRAY ANIMAL here for Adoption SUPPORT STRAY PET ADOPTION</h2>
  <button class="btn btn-dark text-white btn-lg" onclick="window.location.href='register.jsp';" >START REGISTERING ANIMALS</button>
  </div >
</div>
  
  
  <section class="container ourservices text-center">
  <h1 style="font-weight:bold;">OUR FEATURES</h1>
...
<!-- //////////////////////////////////////////// -->
  ...
  <section class="container ourservices text-center">
  <h1 font-bold>Steps to Register a Stray Pet on PawPortal</h1>
  ...
  <div class="row rowsetting">
          <div class="col-lg-4 col-md-4 col-sm-4 col-10 d-block m-auto">
           ...
           <h2>1.Create an Account as Admin/Pet Guardian</h2>
           <p>Create an Account as Admin/Pet Gaurdian on the website and visit 'Register' option to register Stray for adoption/upload information of Stray on the website.</p>
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-10 d-block m-auto">
           ...
           <p>If any Adopter is interested in any Stray pet registered by you , you can have an appointment with the Animal's expected Adopters (if there are any) to have a personal look at the animal<p>
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-10 d-block m-auto">
           ...
           <p> A small mcq based test answered by the Adopter will be sent to you , to verify Adopter's background before giving the pet to them .You are required to give your affirmation to the Adopter based on their Test answers<p>
