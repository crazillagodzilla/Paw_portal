...
int gid1=(int)session.getAttribute("gid");
...
<nav style="background-color:#008080; padding-top:130px;">
    <h3 align="center" style="color:white;">Your Registered Animals</h3>
</nav>
     ...
     if(request.getAttribute("Filt")!=null)
     {
       ...
       if(!Product.isEmpty()){
    	   for(Product p:Product) {
            ...
            <form action="removepet" name="form1" method="post">
