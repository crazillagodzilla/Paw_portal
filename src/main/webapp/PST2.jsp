	...
	<article class="filter-group">
		...
		<div class="filter-content collapse show" id="collapse_1" style="">
			<div class="card-body">
				...
				<ul class="list-menu">
				<li><a>Indie Dog Breed  </a></li>
				<li><a>Western Dog Breed </a></li>
				<li><a>Senior Cat</a></li>
				<li><a>Junior Cat </a></li>
				</ul>
    	   ...
    	   for(Product p:Product) {
               ...
               <div class="card w-100 mx-2" style="width: 18rem;">
                    ...
                    <div class="card-body">
                         ...
                         <h6 class="AGE">Age: <%= p.getAge() %></h6>
                         <div class="mt-3 d-flex justify-content-between">
                           <a href="#" class="btn btn-primary">Add To Cart .......
      				      </a>
      				      <form action="ImageInfoServlet" method="post">
